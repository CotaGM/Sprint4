                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="product-item mb-4">
                                    ...
                                    <!-- CANTIDAD -->
                                    <div class="sm:col-span-3 mb-4">
                                        <label for="cantidad" class="block text-sm font-medium leading-6 text-gray-900 mb-1">Cantidad</label>
                                        <div class="mt-1">
                                    ...
                                    <a href="{{ route('ventas.index') }}" class="rounded-md bg-white px-4 py-3 text-sm font-medium text-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Cancelar</a>
