...
<!-- ID PRODUCTO-->
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
        <input type="number" name="id_producto" id="id_producto" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" placeholder="Código producto"required>
        </div>
      </div>
      @error('id_producto')
            <p class="text-red-500 text-sm">{{ $message }}</p>
...
<div class="sm:col-span-3">
        ...
        <div class="mt-2">
        <input type="number" name="cantidad" id="cantidad" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" placeholder="Cantidad de producto"required>
        </div>
      </div>
      @error('cantidad')
            <p class="text-red-500 text-sm">{{ $message }}</p>
...
<div class="sm:col-span-3">
        ...
        <div class="mt-2">
        <input type="number" name="total_venta" id="total_venta" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" placeholder="Total €"required>
        </div>
      </div>
      @error('total_venta')
            <p class="text-red-500 text-sm">{{ $message }}</p>
