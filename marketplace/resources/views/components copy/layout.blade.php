...
<div class="min-h-full">
  <nav class="bg-white shadow h-24"> <!-- Ajuste de la altura de la barra del menú -->
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full"> <!-- Asegurarse de que el contenedor tenga la misma altura -->
      <div class="flex h-full items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <!-- Reemplaza la URL de abajo con la URL de tu logo -->
